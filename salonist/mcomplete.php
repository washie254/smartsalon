                ...
                <div class="card">
                    <div class="card-body">
                       ...
                       <b>Clinet Description :</b><?=$description?><br>
                        ...
                        <form action="mcomplete.php" method="post">
                            <input type="text" name="bid" value="<?=$bid?>" style="opacity:0.3;" readonly>
                            <div class="form-group">
                                <label for="Time Sample">Booking remarks</label>
                                <textarea type="text" class="form-control" name="bdescription" id="remarks" placeholder="provide some booking remarks" required></textarea>
                            </div>
