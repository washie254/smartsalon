...
<div class="infobox">
	<div class="container">
		<div class="sixteen columns">SMART SALON MOTHER NAVIGATOR<a href="#">HELLO VISITOR :)</a></div>
	</div>
</div>
...
<div class="container">
	<div class="sixteen columns">
		<h3 class="margin-bottom-25" style="position:center; float:center;">SELECT YOUR DESTINATION BEAUTY TRAVELLER :) </h3>
		<ul id="popular-categories">
			<li><a href="salonist/"><i class="fa fa-user"></i>saloonist | Practitioners</a></li>
			<li><a href="user/"><i class="fa fa-user"></i>User | Visitor</a></li>
			<li><a href="admin/"><i class="fa fa-graduation-cap"></i>Administrator</a></li>
