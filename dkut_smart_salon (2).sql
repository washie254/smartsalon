...
INSERT INTO `bookings` (`id`, `username`, `salonist`, `styleid`, `datebooked`, `timeboked`, `prefereddate`, `preferdtime`, `description`, `salonistreply`, `status`, `reasonforrejection`, `bookingremarks`) VALUES
(1, 'user1', 'salonist1', 1, '0000-00-00', '03:08:00', '2019-11-15', '10:10:00', 'i need a quick makeover', 'carry your purse please , i wanna see it', 'COMPLETE', 'incapable of identifying the date of your booking', ''),
(2, 'user1', 'salonist1', 2, '2019-07-11', '03:10:00', '2019-11-29', '10:10:00', 'i would like to have an afro', 'okay, kindly keep time since i have allocated you that slot ', 'COMPLETE', '', ''),
...
(4, 'user1', 'salonist1', 5, '0000-00-00', '12:00:00', '2019-11-28', '10:20:00', 'i need a nice make over', 'have received your order. lets meet then', 'COMPLETE', '', ''),
(5, 'user1', 'salonist1', 1, '2019-11-26', '05:16:00', '2019-11-27', '10:30:00', 'i need to have my hair done', 'kind come with the type of hair of your choice', 'COMPLETE', '', '');
...
INSERT INTO `ratings` (`id`, `styleid`, `salonistid`, `review`, `clienid`, `rating`) VALUES
(3, 2, 1, 'she is amazing, i would recommend her to anyone ', 1, 4),
(4, 1, 1, 'she has such a nice heart, and does as she promises, she will always be my firt option whenever i need a do over . check her out guys', 1, 5),
(5, 1, 1, 'that was quite a fantastic job. the hair however was a little loose after a week . though you did a good job to salvage my image for a while back then. thank you ', 1, 3);
